...
function load_list(){
                ...
                request.open("POST", "http:\/\/104.155.234.246/project2/load_list.php", true);
...
request.open("POST", "http:\/\/104.155.234.246/project2/download_link.php",true);
request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
request.send(the_data);
var link_list="";
request.onreadystatechange = function() {
      if (request.readyState == 4) {
		...
		window.location = 'http:\/\/104.155.234.246/project2/uploads/'+link.innerHTML;
	}
    };
